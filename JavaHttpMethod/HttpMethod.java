...
public class HttpMethod {
     ...
     * @return
     */
    public HttpMethod addParam(Map<String, Object> param){
     ...
     * @return
     */
    public HttpMethod addParam(Map<String, Object> param, String encoding){
     ...
     * @return
     */
    public HttpMethod addParam(String name, String value){
        return addParam(name, value, DEFAULT_ENCODING);
    }
     
    public HttpMethod addParam(String name, String value, String encoding){
     ...
     * @return
     */
    public HttpMethod addParam(String name, File file){
        return addParam(name, file, DEFAULT_ENCODING);
    }
    
    public HttpMethod addParam(String name, File file, String encoding){
        if( file.exists() ){
            try{
                params.addPart(
                        name,
